! function(e) {
	...
	! function(i, a) {
		var s = function() {
			var e = {};
			return a.apply(e, arguments), e.moxie
		};
		r = [], n = s, void 0 !== (o = "function" == typeof n ? n.apply(t, r) : n) && (e.exports = o)
		...
		! function(e, t) {
			...
			n("moxie/core/utils/Basic", [], function() {
					...
					function a(t, i, n) {
						var r = n[0];
						return u(n, function(n, s) {
							s > 0 && u(n, function(n, s) {
								var u = -1 !== f(e(n), ["array", "object"]);
								if(void 0 === n || t && void 0 === r[s]) return !0;
								u && i && (n = o(n)), e(r[s]) === e(n) && u ? a(t, i, [r[s], n]) : r[s] = n
							})
						}), r
					}
					...
					function d(e, t) {
						...
						u(e, function(e, o) {
							e(function(e) {
								...
								a.shift(), r[o] = a, ++i === n && (r.unshift(null), t.apply(this, r))
							})
						})
					}
					...
					return {
						...
						atob: function(e, i) {
							...
							var n, r, o, a, s, u, l, c, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
								f = 0,
								p = 0,
								h = "",
								m = [];
							...
							e += "";
							do {
								a = d.indexOf(e.charAt(f++)), s = d.indexOf(e.charAt(f++)), u = d.indexOf(e.charAt(f++)), l = d.indexOf(e.charAt(f++)), c = a << 18 | s << 12 | u << 6 | l, n = c >> 16 & 255, r = c >> 8 & 255, o = 255 & c, m[p++] = 64 == u ? String.fromCharCode(n) : 64 == l ? String.fromCharCode(n, r) : String.fromCharCode(n, r, o)
							} while (f < e.length);
						...
						btoa: function(t, i) {
							...
							if(!t) return t;
							do {
								n = t.charCodeAt(f++), r = t.charCodeAt(f++), o = t.charCodeAt(f++), c = n << 16 | r << 8 | o, a = c >> 18 & 63, s = c >> 12 & 63, u = c >> 6 & 63, l = 63 & c, m[p++] = d.charAt(a) + d.charAt(s) + d.charAt(u) + d.charAt(l)
							} while (f < t.length);
							h = m.join("");
							var g = t.length % 3;
					...
					function t(e, t, i) {
						...
						for(e = s(e), t = s(t), r = Math.max(e.length, t.length), n = 0; n < r; n++)
							if(e[n] != t[n]) {
					...
					var i = function(e) {
							var t = "name",
								...
								a = {
									browser: [
										...
										[t, [i, r.str, o.browser.oldsafari.version]],
									...
									os: [
										...
										[t, [i, r.str, o.os.windows.version]],
										[/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
										[
											[t, "Windows"],
											[i, r.str, o.os.windows.version]
										],
										[/\((bb)(10);/i],
										[
											[t, "BlackBerry"], i
							...
							return function(e) {
								...
								this.getBrowser = function() {
									return r.rgx.apply(this, a.browser)
								}, this.getEngine = function() {
									return r.rgx.apply(this, a.engine)
								}, this.getOS = function() {
									return r.rgx.apply(this, a.os)
					...
					return o.OS = o.os, a && (o.debug = {
						runtime: !0,
						events: !1
					}, o.log = function() {
						var t = arguments[0];
						if("string" === e.typeOf(t) && (t = e.sprintf.apply(this, arguments)), window && window.console && window.console.log) window.console.log(t);
						else if(document) {
					...
					return {
						...
						getPos: function(t, i) {
							...
							var r, o, a, s = 0,
								u = 0,
								l = document;
							if(t = t, i = i || l.body, t && t.getBoundingClientRect && "IE" === e.browser && (!l.documentMode || l.documentMode < 8)) return o = n(t), a = n(i), {
								x: o.x - a.x,
								y: o.y - a.y
							};
					...
					return i.extend(n.prototype, {
						...
						dispatchEvent: function(n) {
							...
							if(-1 !== n.indexOf("::") ? function(e) {
								...
								}), u = [].slice.call(arguments), u.shift(), c.type = n, u.unshift(c), a && e.debug.events && e.log("Event '%s' fired on %u", c.type, o);
								var f = [];
								i.each(s, function(e) {
									u[0].target = e.scope, c.async ? f.push(function(t) {
										setTimeout(function() {
					...
					function r(n, o, u, l, c) {
						...
						n = n || {}, s[p] = this, u = t.extend({
							...
							upload_filesize: !0,
							use_http_method: !0
						}, u), n.preferred_caps && (h = r.getMode(l, n.preferred_caps, h)), a && e.debug.runtime && e.log("\tdefault mode: %s", h), d = function() {
							var e = {};
							return {
							...
							shimExec: function(e, t) {
								...
								return f.getShim().exec.call(this, this.uid, e, t, i)
							},
							exec: function(e, t) {
								var i = [].slice.call(arguments, 2);
								return f[e] && f[e][t] ? f[e][t].apply(this, i) : f.shimExec.apply(this, arguments)
							},
							destroy: function() {
								if(f) {
									var e = i.get(this.shimid);
									e && e.parentNode.removeChild(e), d && d.removeAllInstances(), this.unbindAll(), delete s[this.uid], this.uid = null, p = f = d = e = null
								}
							}
							...
							if(t.each(n, function(n, r) {
									if(i.hasOwnProperty(r)) {
										...
										if("string" == typeof s && (s = [s]), o) {
											if(!(o = t.arrayIntersect(o, s))) return a && e.debug.runtime && e.log("\t\t%c: %v (conflicting mode requested: %s)", r, n, s), o = !1
										} else o = s
									}
									a && e.debug.runtime && e.log("\t\t%c: %v (compatible modes: %s)", r, n, o)
					...
					return function() {
						...
						i.extend(this, {
							connectRuntime: function(o) {
								function s(i) {
									var u, c;
									return i.length ? (u = i.shift().toLowerCase(), (c = n.getConstructor(u)) ? (a && e.debug.runtime && (e.log("Trying runtime: %s", u), e.log(o)), r = new c(o), r.bind("Init", function() {
										r.initialized = !0, a && e.debug.runtime && e.log("Runtime '%s' initialized", r.type), setTimeout(function() {
											r.clients++, l.ruid = r.uid, l.trigger("RuntimeInit", r)
										}, 1)
									}), r.bind("Error", function() {
										a && e.debug.runtime && e.log("Runtime '%s' failed to initialize", r.type), r.destroy(), s(i)
									}), r.bind("Exception", function(i, n) {
										var r = n.name + "(#" + n.code + ")" + (n.message ? ", from: " + n.message : "");
										a && e.debug.runtime && e.log("Runtime '%s' has thrown an exception: %s", this.type, r), l.trigger("RuntimeError", new t.RuntimeError(t.RuntimeError.EXCEPTION_ERR, r))
									}), a && e.debug.runtime && e.log("\tselected mode: %s", r.mode), r.mode ? void r.init() : void r.trigger("Error")) : (a && e.debug.runtime && e.log("Constructor for '%s' runtime is not available.", u), void s(i))) : (l.trigger("RuntimeError", new t.RuntimeError(t.RuntimeError.NOT_INIT_ERR)), void(r = null))
								}
								var u, l = this;
				...
				}), n("moxie/file/FileInput", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Mime", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/I18n", "moxie/runtime/Runtime", "moxie/runtime/RuntimeClient"], function(e, t, i, n, r, o, s, u, l) {
					function c(o) {
						a && t.log("Instantiating FileInput...");
						var c, f, p;
						if(-1 !== e.inArray(e.typeOf(o), ["string", "node"]) && (o = {
								browse_button: o
							}), !(f = n.get(o.browse_button))) throw new r.DOMException(r.DOMException.NOT_FOUND_ERR);
						p = {
							accept: [{
						...
						}, o = e.extend({}, p, o), "string" == typeof o.required_caps && (o.required_caps = u.parseCaps(o.required_caps)), "string" == typeof o.accept && (o.accept = i.mimes2extList(o.accept)), c = n.get(o.container), c || (c = document.body), "static" === n.getStyle(c, "position") && (c.style.position = "relative"), c = f = null, l.call(this), e.extend(this, {
							uid: e.guid("uid_"),
							ruid: null,
							shimid: null,
							files: null,
							init: function() {
								...
								t.bind("RuntimeInit", function(i, r) {
									t.ruid = r.uid, t.shimid = r.shimid, t.bind("Ready", function() {
										...
										var t, i, a, s, u;
										a = n.get(o.browse_button), s = n.get(r.shimid), a && (t = n.getPos(a, n.get(o.container)), i = n.getSize(a), u = parseInt(n.getStyle(a, "z-index"), 10) || 0, s && e.extend(s.style, {
											top: t.y + "px",
											left: t.x + "px",
											width: i.w + "px",
											height: i.h + "px",
				...
				}), n("moxie/file/FileDrop", ["moxie/core/I18n", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/file/File", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget", "moxie/core/utils/Mime"], function(e, t, i, n, r, o, s, u, l) {
					function c(i) {
						a && r.log("Instantiating FileDrop...");
						var o, u = this;
						"string" == typeof i && (i = {
							drop_zone: i
						}), o = {
						...
						}, i = "object" == typeof i ? n.extend({}, o, i) : o, i.container = t.get(i.drop_zone) || document.body, "static" === t.getStyle(i.container, "position") && (i.container.style.position = "relative"), "string" == typeof i.accept && (i.accept = l.mimes2extList(i.accept)), s.call(u), n.extend(u, {
							uid: n.guid("uid_"),
							ruid: null,
							files: null,
							init: function() {
					...
					var t = function(i, n) {
						...
						if(r = !d && !u.scheme, (d || r) && (u.scheme = n.scheme), r) {
							...
							var f = "";
							/^[^\/]/.test(u.path) && (f = n.path, f = /\/[^\/]*\.[^\/]*$/.test(f) ? f.replace(/\/[^\/]+$/, "/") : f.replace(/\/?$/, "/")), u.path = f + (u.path || "")
						}
					...
					return function() {
						function n(e, t) {
							...
							switch(e) {
								...
								case "readAsText":
									for(var o = "", a = 0, s = r.length; a < s; a++) o += String.fromCharCode(r[a]);
									return o
							}
						}
					...
					function p() {
						function i(e, t) {
							if(T.hasOwnProperty(e)) return 1 === arguments.length ? c.can("define_property") ? T[e] : S[e] : void(c.can("define_property") ? T[e] = t : S[e] = t)
						}
						...
						function u(t) {
							...
							function r(r) {
								b.bind("LoadStart", function(e) {
									i("readyState", p.LOADING), s.dispatchEvent("readystatechange"), s.dispatchEvent(e), k && s.upload.dispatchEvent(e)
								}), b.bind("Progress", function(e) {
									i("readyState") !== p.LOADING && (i("readyState", p.LOADING), s.dispatchEvent("readystatechange")), s.dispatchEvent(e)
								}), b.bind("UploadProgress", function(e) {
									k && s.upload.dispatchEvent({
										type: "progress",
										lengthComputable: !1,
										total: e.total,
										loaded: e.loaded
									...
									i("readyState", p.DONE), i("status", Number(r.exec.call(b, "XMLHttpRequest", "getStatus") || 0)), i("statusText", h[i("status")] || ""), i("response", r.exec.call(b, "XMLHttpRequest", "getResponse", i("responseType"))), ~e.inArray(i("responseType"), ["text", ""]) ? i("responseText", i("response")) : "document" === i("responseType") && i("responseXML", i("response")), P = r.exec.call(b, "XMLHttpRequest", "getAllResponseHeaders"), s.dispatchEvent("readystatechange"), i("status") > 0 ? (k && s.upload.dispatchEvent(t), s.dispatchEvent(t)) : (F = !0, s.dispatchEvent("error")), n()
								}), b.bind("Abort", function(e) {
									s.dispatchEvent(e), n()
								}), b.bind("Error", function(e) {
									F = !0, i("readyState", p.DONE), s.dispatchEvent("readystatechange"), L = !0, s.dispatchEvent(e), n()
							...
							var s = this;
							w = (new Date).getTime(), b = new a, "string" == typeof z.required_caps && (z.required_caps = o.parseCaps(z.required_caps)), z.required_caps = e.extend({}, z.required_caps, {
								return_response_type: s.responseType
							}), t instanceof l && (z.required_caps.send_multipart = !0), e.isEmptyObj(I) || (z.required_caps.send_custom_headers = !0), M || (z.required_caps.do_cors = !0), z.ruid ? r(b.connectRuntime(z)) : (b.bind("RuntimeInit", function(e, t) {
								r(t)
						...
						e.extend(this, T, {
							...
							open: function(o, a, s, u, l) {
								...
								if(a = n.utf8_encode(a), c = r.parseUrl(a), M = r.hasSameOrigin(c), v = r.resolveUrl(a), (u || l) && !M) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
								if(_ = u || c.user, y = l || c.pass, !1 === (A = s || !0) && (i("timeout") || i("withCredentials") || "" !== i("responseType"))) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
								C = !A, N = !1, I = {}, g.call(this), i("readyState", p.OPENED), this.dispatchEvent("readystatechange")
							},
							setRequestHeader: function(r, o) {
								...
								if(i("readyState") !== p.OPENED || N) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
								if(/[\u0100-\uffff]/.test(r) || n.utf8_encode(r) !== r) throw new t.DOMException(t.DOMException.SYNTAX_ERR);
								return r = e.trim(r).toLowerCase(), !~e.inArray(r, a) && !/^(proxy\-|sec\-)/.test(r) && (I[r] ? I[r] += ", " + o : I[r] = o, !0)
							},
							...
							getResponseHeader: function(t) {
								return t = t.toLowerCase(), F || ~e.inArray(t, ["set-cookie", "set-cookie2"]) ? null : P && "" !== P && (R || (R = {}, e.each(P.split(/\r\n/), function(t) {
									var i = t.split(/:\s+/);
							...
							send: function(i, r) {
								if(z = "string" === e.typeOf(r) ? {
										ruid: r
									} : r || {}, this.readyState !== p.OPENED || N) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
								if(i instanceof s) z.ruid = i.ruid, D = i.type || "application/octet-stream";
								...
								this.withCredentials || (this.withCredentials = z.required_caps && z.required_caps.send_browser_cookies && !M), k = !C && this.upload.hasEventListener(), F = !1, L = !i, C || (N = !0), u.call(this, i)
							},
							abort: function() {
								if(F = !0, C = !1, ~e.inArray(i("readyState"), [p.UNSENT, p.OPENED, p.DONE])) i("readyState", p.UNSENT);
								else {
									if(i("readyState", p.DONE), N = !1, !b) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
					...
					function r() {
						...
						function o(t, i) {
							...
							u = i, n.bind("TransportingProgress", function(t) {
								(d = t.loaded) < c && -1 === e.inArray(n.state, [r.IDLE, r.DONE]) && a.call(n)
						...
						function a() {
							var e, i = this,
								n = c - d;
							f > n && (f = n), e = t.btoa(l.substr(d, f)), u.exec.call(i, "Transporter", "receive", e, c)
						}
						var s, u, l, c, d, f;
						i.call(this), e.extend(this, {
							...
							transport: function(t, i, r) {
								...
								if(r = e.extend({
										chunk_size: 204798
									}, r), (s = r.chunk_size % 3) && (r.chunk_size += 3 - s), f = r.chunk_size, n.call(this), l = t, c = t.length, "string" === e.typeOf(r) || r.ruid) o.call(a, i, this.connectRuntime(r));
								else {
									var u = function(e, t) {
					...
					function p() {
						...
						function l(t) {
							...
							try {
								...
								} else if(-1 !== e.inArray(n, ["blob", "file"])) l.call(this, new d(null, t), arguments[1]);
								else if("string" === n) "data:" === t.substr(0, 5) ? l.call(this, new c(null, {
									data: t
						...
						a.call(this), e.extend(this, {
							...
							resize: function(t) {
								...
								try {
									...
									if(o.width > p.MAX_RESIZE_WIDTH || o.height > p.MAX_RESIZE_HEIGHT) throw new i.ImageError(i.ImageError.MAX_RESOLUTION_ERR);
							...
							embed: function(n, r) {
								function o(t, r) {
									...
									if(u.can("use_data_uri_of", d.length)) n.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" />', o.destroy(), l.trigger("embedded");
									else {
										var p = new s;
										p.bind("TransportingComplete", function() {
											a = l.connectRuntime(this.result.ruid), l.bind("Embedded", function() {
											...
											}, 999), a.exec.call(l, "ImageView", "display", this.result.uid, width, height), o.destroy()
					...
					return p.MAX_RESIZE_WIDTH = 8192, p.MAX_RESIZE_HEIGHT = 8192, p.prototype = l.instance, p
					...
					var n = {},
						...
						o = function(o, a, s, u) {
							var l, c;
							a = a.toLowerCase(), o.addEventListener ? (l = s, o.addEventListener(a, l, !1)) : o.attachEvent && (l = function() {
								var e = window.event;
								e.target || (e.target = e.srcElement), e.preventDefault = t, e.stopPropagation = i, s(e)
							}, o.attachEvent("on" + a, l)), o[r] || (o[r] = e.guid()), n.hasOwnProperty(o[r]) || (n[o[r]] = {}), c = n[o[r]], c.hasOwnProperty(a) || (c[a] = []), c[a].push({
								func: l,
								orig: s,
								key: u
							})
						...
						a = function(t, i, o) {
							...
							if(i = i.toLowerCase(), t[r] && n[t[r]] && n[t[r]][i]) {
								a = n[t[r]][i];
								for(var s = a.length - 1; s >= 0 && (a[s].orig !== o && a[s].key !== o || (t.removeEventListener ? t.removeEventListener(i, a[s].func, !1) : t.detachEvent && t.detachEvent("on" + i, a[s].func), a[s].orig = null, a[s].func = null, a.splice(s, 1), void 0 === o)); s--);
						...
						i.extend(this, {
							init: function(u) {
								...
								e = u, d = e.accept.mimes || o.extList2mimes(e.accept, g.can("filter_by_extension")), c = g.getShimContainer(), c.innerHTML = '<input id="' + g.uid + '" type="file" style="font-size:999px;opacity:0;"' + (e.multiple && g.can("select_multiple") ? "multiple" : "") + (e.directory && g.can("select_folder") ? "webkitdirectory directory" : "") + (d ? ' accept="' + d.join(",") + '"' : "") + " />", l = n.get(g.uid), i.extend(l.style, {
									...
									width: "100%",
									height: "100%"
								}), f = n.get(e.browse_button), s = n.getStyle(f, "z-index") || "auto", g.can("summon_file_dialog") && ("static" === n.getStyle(f, "position") && (f.style.position = "relative"), r.addEvent(f, "click", function(e) {
									var t = n.get(g.uid);
									t && !t.disabled && t.click(), e.preventDefault()
								}, m.uid), m.bind("Refresh", function() {
									p = parseInt(s, 10) || 1, n.get(e.browse_button).style.zIndex = p, this.getRuntime().getShimContainer().style.zIndex = p - 1
								})), h = g.can("summon_file_dialog") ? f : c, r.addEvent(h, "mouseover", function() {
					...
					function a() {
						...
						i.extend(this, {
							init: function(t) {
								var n, o = this;
								p = t, h = o.ruid, g = s(p.accept), n = p.container, r.addEvent(n, "dragover", function(t) {
							...
							destroy: function() {
								r.removeAllEvents(p && n.get(p.container), this.uid), h = m = g = p = null
							}
						})
					}
					return e.FileDrop = a
					...
					function l() {
						...
						function d(e) {
							var t = "----moxieboundary" + (new Date).getTime(),
								i = "\r\n",
								n = "";
							if(!this.getRuntime().can("send_binary_string")) throw new s.RuntimeError(s.RuntimeError.NOT_SUPPORTED_ERR);
							return f.setRequestHeader("Content-Type", "multipart/form-data; boundary=" + t), e.each(function(e, r) {
						...
						t.extend(this, {
							send: function(i, r) {
								var s = this,
									...
									m = !1;
								if(p = i.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), f = l(), f.open(i.method, i.url, i.async, i.user, i.password), r instanceof o) r.isDetached() && (m = !0), r = r.getSource();
								else if(r instanceof a) {
									if(r.hasBlob())
										if(r.getBlob().isDetached()) r = d.call(s, r), m = !0;
										else if((c || h) && "blob" === t.typeOf(r.getBlob().getSource()) && window.FileReader) return void e.call(s, i, r);
									if(r instanceof a) {
								...
								f.upload ? (i.withCredentials && (f.withCredentials = !0), f.addEventListener("load", function(e) {
									s.trigger(e)
									...
									switch(f.readyState) {
										...
										case 3:
											var e, t;
											try {
												n.hasSameOrigin(i.url) && (e = f.getResponseHeader("Content-Length") || 0), f.responseText && (t = f.responseText.length)
											} catch(i) {
												e = t = 0
											}
											s.trigger({
								...
								}), "" !== i.responseType && "responseType" in f && ("json" !== i.responseType || u.can("return_response_type", "json") ? f.responseType = i.responseType : f.responseType = "text"), m ? f.sendAsBinary ? f.sendAsBinary(r) : function() {
					...
					return function i(n) {
						...
						for(o = 2; o <= r.length();)
							if((a = r.SHORT(o)) >= 65488 && a <= 65495) o += 2;
							else {
								if(65498 === a || 65497 === a) break;
								u = r.SHORT(o + 2) + 2, a >= 65505 && a <= 65519 && s.push({
									hex: a,
									name: "APP" + (15 & a),
									start: o,
									length: u,
						...
						return r.clear(), {
							...
							restore: function(t) {
								var i, n, r;
								for(r = new e(t), o = 65504 == r.SHORT(2) ? 4 + r.SHORT(4) : 2, n = 0, i = s.length; n < i; n++) r.SEGMENT(o, 0, s[n].segment), o += s[n].length;
							...
							get: function(e) {
								for(var t = [], i = 0, n = s.length; i < n; i++) s[i].name === e.toUpperCase() && t.push(s[i].segment);
								return t
							},
							set: function(e, t) {
								var i, n, r, o = [];
								for("string" == typeof t ? o.push(t) : o = t, i = n = 0, r = s.length; i < r && (s[i].name === e.toUpperCase() && (s[i].segment = o[n], s[i].length = o[n].length, n++), !(n >= o.length)); i++);
							},
							purge: function() {
								this.headers = s = []
							}
					...
					function r(o) {
						function a(i, r) {
							...
							for(o = m.SHORT(i), a = 0; a < o; a++)
								if(g = [], p = i + 2 + 12 * a, (s = r[m.SHORT(p)]) !== t) {
									if(u = x[m.SHORT(p += 2)], l = m.LONG(p += 2), !(f = _[u])) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
									if(p += 4, f * l > 4 && (p = m.LONG(p) + d.tiffHeader), p + f * l >= this.length()) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
									"ASCII" !== u ? (g = m.asArray(u, p, l), h = 1 == l ? g[0] : g, c.hasOwnProperty(s) && "object" != typeof h ? v[s] = c[s][h] : v[s] = h) : v[s] = e.trim(m.STRING(p, l).replace(/\0$/, ""))
								}
							return v
						}
						...
						if(i.call(this, o), l = {
								...
								EXIF: function() {
									...
									if(d.exifIFD) {
										try {
											t = a.call(this, d.exifIFD, l.exif)
										} catch(e) {
											return null
										}
								...
								thumb: function() {
									if(d.IFD1) try {
										var e = a.call(this, d.IFD1, l.thumb);
						...
						d.IFD0 = d.tiffHeader + this.LONG(f += 2), p = a.call(this, d.IFD0, l.tiff), "ExifIFDPointer" in p && (d.exifIFD = d.tiffHeader + p.ExifIFDPointer, delete p.ExifIFDPointer), "GPSInfoIFDPointer" in p && (d.gpsIFD = d.tiffHeader + p.GPSInfoIFDPointer, delete p.GPSInfoIFDPointer), e.isEmptyObj(p) && (p = null);
					...
					function c() {
						...
						t.extend(this, {
							loadFromBlob: function(e) {
								...
								if(y = e, e.isDetached()) return _ = e.getSource(), void f.call(this, _);
								p.call(this, e.getSource(), function(e) {
									n && (_ = c(e)), f.call(this, e)
								})
							},
							loadFromImage: function(e, t) {
								this.meta = e.meta, y = new o(null, {
									...
									size: e.size,
									type: e.type
								}), f.call(this, t ? _ = e.getAsBinaryString() : e.getAsDataURL())
							},
							getInfo: function() {
								var t, i = this.getRuntime();
								return !v && _ && i.can("access_image_binary") && (v = new a(_)), t = {
									width: e().width || 0,
									height: e().height || 0,
							...
							resize: function(t, i, n) {
								...
								if(r.width = t.width, r.height = t.height, r.getContext("2d").drawImage(e(), t.x, t.y, t.width, t.height, 0, 0, r.width, r.height), x = s.scale(r, i), !(b = n.preserveHeaders)) {
							...
							getAsBinaryString: function(e, t) {
								...
								if("image/jpeg" !== e) _ = c(w.getAsDataURL(e, t));
								else {
									var i;
									t || (t = 90), l();
									try {
					...
					function c(l) {
						...
						l = e.extend({
						...
						}, "client"), s() < 11.3 && (a && t.debug.runtime && t.log("\tFlash didn't meet minimal version requirement (11.3)."), this.mode = !1), e.extend(this, {
							getShim: function() {
							...
							init: function() {
								...
								o = this.getShimContainer(), e.extend(o.style, {
									...
									p && !p.initialized && (p.trigger("Error", new n.RuntimeError(n.RuntimeError.NOT_INIT_ERR)), a && t.debug.runtime && t.log("\tFlash failed to initialize within a specified period of time (typically 5s)."))
								}, 5e3)
							},
							destroy: function(e) {
								return function() {
									u(p.uid), e.call(p), clearTimeout(c), l = c = e = p = null
								}
							}(this.destroy)
						}, f)
					}
					...
					function u(u) {
						...
						u = e.extend({
						...
						}), s("2.0.31005.0") && "Opera" !== t.browser || (a && t.debug.runtime && t.log("\tSilverlight is not installed or minimal version (2.0.31005.0) requirement not met (not likely)."), this.mode = !1), e.extend(this, {
							getShim: function() {
							...
							init: function() {
								...
								e = this.getShimContainer(), e.innerHTML = '<object id="' + this.uid + '" data="data:application/x-silverlight," type="application/x-silverlight-2" width="100%" height="100%" style="outline:none;"><param name="source" value="' + u.xap_url + '"/><param name="background" value="Transparent"/><param name="windowless" value="true"/><param name="enablehtmlaccess" value="true"/><param name="initParams" value="uid=' + this.uid + ",target=" + t.global_event_dispatcher + '"/></object>', d = setTimeout(function() {
									f && !f.initialized && (f.trigger("Error", new n.RuntimeError(n.RuntimeError.NOT_INIT_ERR)), a && t.debug.runtime && t.log("Silverlight failed to initialize within a specified period of time (5-10s)."))
								}, "Windows" !== t.OS ? 1e4 : 5e3)
							},
							destroy: function(e) {
								return function() {
									e.call(f), clearTimeout(d), u = d = e = f = null
								}
							}(this.destroy)
						}, c)
					}
					...
					return e.Image = t.extend({}, n, {
						getInfo: function() {
							...
							return o.meta && (t.each(n, function(e) {
								...
								if(s && s.keys)
									for(r.meta[e] = {}, i = 0, n = s.keys.length; i < n; i++) t = s.keys[i], (a = s[t]) && (/^(\d|[1-9]\d+)$/.test(a) ? a = parseInt(a, 10) : /^\d*\.\d+$/.test(a) && (a = parseFloat(a)), r.meta[e][t] = a)
					...
					function s() {
						function e() {
							var o, l, d, f, p, h, m = this,
								g = m.getRuntime();
							h = i.guid("uid_"), o = g.getShimContainer(), s && (d = n.get(s + "_form")) && i.extend(d.style, {
								top: "100%"
							}), f = document.createElement("form"), f.setAttribute("id", h + "_form"), f.setAttribute("method", "post"), f.setAttribute("enctype", "multipart/form-data"), f.setAttribute("encoding", "multipart/form-data"), i.extend(f.style, {
								overflow: "hidden",
								position: "absolute",
								top: 0,
								left: 0,
								width: "100%",
								height: "100%"
							}), p = document.createElement("input"), p.setAttribute("id", h), p.setAttribute("type", "file"), p.setAttribute("accept", c.join(",")), i.extend(p.style, {
								fontSize: "999px",
								opacity: 0
							}), f.appendChild(p), o.appendChild(f), i.extend(p.style, {
								position: "absolute",
								top: 0,
								left: 0,
								width: "100%",
								height: "100%"
							}), "IE" === a.browser && a.verComp(a.version, 10, "<") && i.extend(p.style, {
								filter: "progid:DXImageTransform.Microsoft.Alpha(opacity=0)"
							}), p.onchange = function() {
								var i;
								if(this.value) {
									if(this.files) {
										if(i = this.files[0], 0 === i.size) return void f.parentNode.removeChild(f)
									} else i = {
										name: this.value
									};
									i = new t(g.uid, i), this.onchange = function() {}, e.call(m), m.files = [i], p.setAttribute("id", i.uid), f.setAttribute("id", i.uid + "_form"), m.trigger("change"), p = f = null
								}
						...
						i.extend(this, {
							init: function(t) {
								var i, a = this,
									s = a.getRuntime();
								u = t, c = t.accept.mimes || o.extList2mimes(t.accept, s.can("filter_by_extension")), i = s.getShimContainer(),
									function() {
										var e, o, c;
										e = n.get(t.browse_button), l = n.getStyle(e, "z-index") || "auto", s.can("summon_file_dialog") && ("static" === n.getStyle(e, "position") && (e.style.position = "relative"), a.bind("Refresh", function() {
											o = parseInt(l, 10) || 1, n.get(u.browse_button).style.zIndex = o, this.getRuntime().getShimContainer().style.zIndex = o - 1
										})), c = s.can("summon_file_dialog") ? e : i, r.addEvent(c, "mouseover", function() {
							...
							setOption: function(e, t) {
								...
								"accept" == e && (c = t.mimes || o.extList2mimes(t, r.can("filter_by_extension"))), (i = n.get(s)) && i.setAttribute("accept", c.join(","))
							},
							disable: function(e) {
								var t;
							...
							destroy: function() {
								...
								o && r.removeAllEvents(o, this.uid), a && (r.removeAllEvents(a, this.uid), a.style.zIndex = l), i && (r.removeAllEvents(i, this.uid), i.innerHTML = ""), t.removeInstance(this.uid), s = c = u = i = o = a = t = null
							}
						})
					}
					return e.FileInput = s
					...
					function u() {
						...
						t.extend(this, {
							send: function(d, f) {
								var p, h, m, g, v = this,
									x = v.getRuntime();
								if(u = l = null, f instanceof s && f.hasBlob()) {
									if(g = f.getBlob(), p = g.uid, m = i.get(p), !(h = i.get(p + "_form"))) throw new r.DOMException(r.DOMException.NOT_FOUND_ERR)
								} else p = t.guid("uid_"), h = document.createElement("form"), h.setAttribute("id", p + "_form"), h.setAttribute("method", d.method), h.setAttribute("enctype", "multipart/form-data"), h.setAttribute("encoding", "multipart/form-data"), x.getShimContainer().appendChild(h);
								h.setAttribute("target", p + "_iframe"), f instanceof s && f.each(function(e, i) {
										if(e instanceof a) m && m.setAttribute("name", i);
										else {
	...
	! function(a, s) {
		var u = function() {
			var e = {};
			return s.apply(e, arguments), e.plupload
		};
		...
		! function(e, t, i) {
			...
			var r = window.setTimeout,
				...
				u = {
					...
					predictRuntime: function(e, t) {
						var i, n;
						return i = new u.Uploader(e), n = s.thatCan(i.getOption().required_features, t || e.runtimes), i.destroy(), n
					},
			...
			u.addFileFilter("mime_types", function(e, t, i) {
				...
				function c() {
					var e, t, n, r = 0;
					for(A.reset(), e = 0; e < D.length; e++) t = D[e], t.size !== i ? (A.size += t.origSize, n = t.loaded * t.origSize / t.size, (!t.completeTimestamp || t.completeTimestamp > T) && (r += n), A.loaded += n) : A.size = i, t.status == u.DONE ? A.uploaded++ : t.status == u.FAILED ? A.failed++ : A.queued++;
					A.size === i ? A.percent = D.length > 0 ? Math.ceil(A.uploaded / D.length * 100) : 0 : (A.bytesPerSec = Math.ceil(r / ((+new Date - T || 1) / 1e3)), A.percent = A.size > 0 ? Math.ceil(A.loaded / A.size * 100) : 0)
				}
				...
				function h(e, i) {
					...
					u.each(e.runtimes.split(/\s*,\s*/), function(t) {
						...
						o.push(function(o) {
							var l = new t.file.FileInput(u.extend({}, a, {
						...
						o.push(function(i) {
							var o = new t.file.FileDrop(u.extend({}, a, {
								drop_zone: e
							}));
							o.onready = function() {
								var e = s.getInfo(this.ruid);
				...
				function g(e, i, r) {
					function o(e, i, n) {
						...
						switch(e) {
							case "max_file_size":
								...
								break;
							case "chunk_size":
								(i = u.parseSize(i)) && (S[e] = i, S.send_file_name = !0);
								break;
							case "multipart":
							...
							case "filters":
								"array" === u.typeOf(i) && (i = {
									mime_types: i
								}), n ? u.extend(S.filters, i) : S.filters = i, i.mime_types && ("string" === u.typeOf(i.mime_types) && (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)), i.mime_types.regexp = function(e) {
									var t = [];
					...
					"object" == typeof e ? u.each(e, function(e, t) {
						o(t, e, r)
					}) : o(e, i, r), r ? (S.required_features = n(u.extend({}, S)), C = n(u.extend({}, S, {
						required_features: !0
					}))) : l && (a.trigger("Destroy"), h.call(a, S, function(e) {
				...
				function x(e, i) {
					...
					function a(a, c, f) {
						...
						I = new t.xhr.XMLHttpRequest, I.upload && (I.upload.onprogress = function(t) {
							...
							d = e.settings.max_retries, f < s.size ? (c.destroy(), h += f, i.loaded = Math.min(h, s.size), e.trigger("ChunkUploaded", i, {
								offset: i.loaded,
								total: s.size,
								response: I.responseText,
								status: I.status,
								responseHeaders: I.getAllResponseHeaders()
							}), "Android Browser" === u.ua.browser && e.trigger("UploadProgress", i)) : i.loaded = i.size, c = m = null, !h || h >= s.size ? (i.size != i.origSize && (s.destroy(), s = null), e.trigger("UploadProgress", i), i.status = u.DONE, i.completeTimestamp = +new Date, e.trigger("FileUploaded", i, {
								response: I.responseText,
								status: I.status,
								responseHeaders: I.getAllResponseHeaders()
							})) : r(o, 1)
							...
							this.destroy(), I = null
						}, e.settings.multipart && p.multipart ? (I.open(e.settings.http_method, l, !0), u.each(e.settings.headers, function(e, t) {
							I.setRequestHeader(t, e)
						}), m = new t.xhr.FormData, u.each(u.extend(a, e.settings.multipart_params), function(e, t) {
							m.append(t, e)
						...
						})) : (l = u.buildUrl(e.settings.url, u.extend(a, e.settings.multipart_params)), I.open(e.settings.http_method, l, !0), u.each(e.settings.headers, function(e, t) {
							I.setRequestHeader(t, e)
					...
					var s, l = e.settings.url,
						c = e.settings.chunk_size,
						d = e.settings.max_retries,
						p = e.features,
						h = 0;
					i.loaded && (h = i.loaded = c ? c * Math.floor(i.loaded / c) : 0), s = i.getSource(), !u.isEmptyObj(e.settings.resize) && f(s, "send_binary_string") && -1 !== u.inArray(s.type, ["image/jpeg", "image/png"]) ? m.call(this, s, e.settings.resize, function(e) {
						s = e, i.size = e.size, o()
					}) : o()
				}
				...
				function y(e) {
					if(e.state == u.STARTED) T = +new Date;
						...
						for(var t = e.files.length - 1; t >= 0; t--) e.files[t].status == u.UPLOADING && (e.files[t].status = u.QUEUED, c())
				}
				...
				function R(e) {
					e.stop(), u.each(D, function(e) {
						...
						e.destroy()
					}), N = []), k.length && (u.each(k, function(e) {
						e.destroy()
					}), k = []), C = {}, L = !1, T = I = null, A.reset()
				}
				var S, T, A, I, O = u.guid(),
					D = [],
					C = {},
					N = [],
					k = [],
				...
				S = {
					...
					init: function() {
						...
						}), t ? i.trigger("Error", t) : S.browse_button || S.drop_element ? void h.call(i, S, function(e) {
					...
					start: function() {
						this.state != u.STARTED && (this.state = u.STARTED, this.trigger("StateChanged"), a.call(this))
					},
					stop: function() {
					...
					addFile: function(e, i) {
						...
						function a(e) {
							...
							if(e instanceof t.file.File) {
								...
								a(new u.File(e))
							} else e instanceof t.file.Blob ? (a(e.getSource()), e.destroy()) : e instanceof u.File ? (i && (e.name = i), c.push(function(t) {
								n(e, function(i) {
									i || (D.push(e), f.push(e), l.trigger("FileFiltered", e)), r(t, 1)
								})
							})) : -1 !== u.inArray(o, ["file", "blob"]) ? a(new t.file.File(null, e)) : "node" === o && "filelist" === u.typeOf(e.files) ? u.each(e.files, a) : "array" === o && (i = null, u.each(e, a))
						}
						var s, l = this,
							c = [],
							f = [];
						s = d(), a(e), c.length && u.inSeries(c, function() {
							f.length && l.trigger("FilesAdded", f)
						})
					},
					...
					destroy: function() {
						this.trigger("Destroy"), S = A = null, this.unbindAll()
					}
				})
...
//				that.detectIEVersion() ? console.log(n) : (t.unshift(i), console.log.apply(console, t)), document.getElementById("qiniu-js-sdk-log") && (document.getElementById("qiniu-js-sdk-log").innerHTML += "<p>" + n + "</p>")
			...
			function StatisticsLogger() {
				...
				this.log = function(e, t, i, o, a, s, u, l, c, d) {
					var f = Array.prototype.join.call(arguments, ",");
					n.push({
						log: f,
						status: r.waiting
					}), logger.debug("[STATISTICS] send log to statistics server", f)
				}, setInterval(e, 1e3)
			}
			...
			this.resetUploadUrl = function(e) {
				...
				for(var a = 0; a < o; a++) {
					...
					if(s < 128) i++;
						...
						if(64512 & l ^ !0) throw new RangeError("Unmatched lead surrogate at " + (a - 1));
						s = ((1023 & s) << 10) + (1023 & l) + 65536, u = String.fromCharCode(s >> 18 | 240, s >> 12 & 63 | 128, s >> 6 & 63 | 128, 63 & s | 128)
					}
					null !== u && (i > t && (r += n.slice(t, i)), r += u, t = i = a + 1)
				}
				return i > t && (r += n.slice(t, o)), r
			}, this.base64_decode = function(e) {
				var t, i, n, r, o, a, s, u, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
					c = 0,
					d = 0,
					f = [];
				if(!e) return e;
				e += "";
				do {
					r = l.indexOf(e.charAt(c++)), o = l.indexOf(e.charAt(c++)), a = l.indexOf(e.charAt(c++)), s = l.indexOf(e.charAt(c++)), u = r << 18 | o << 12 | a << 6 | s, t = u >> 16 & 255, i = u >> 8 & 255, n = 255 & u, f[d++] = 64 === a ? String.fromCharCode(t) : 64 === s ? String.fromCharCode(t, i) : String.fromCharCode(t, i, n)
				} while (c < e.length);
				return f.join("")
				...
				do {
					t = e.charCodeAt(c++), i = e.charCodeAt(c++), n = e.charCodeAt(c++), u = t << 16 | i << 8 | n, r = u >> 18 & 63, o = u >> 12 & 63, a = u >> 6 & 63, s = 63 & u, p[d++] = l.charAt(r) + l.charAt(o) + l.charAt(a) + l.charAt(s)
				} while (c < e.length);
				...
				var t = function(e) {
					...
					i = function(i) {
						var n = t(i),
							r = "https://api.qiniu.com/v2/query?ak=" + n.ak + "&bucket=" + n.bucket;
						logger.debug("putPolicy: ", n), logger.debug("get uphosts from: ", r);
						var o, a = that.detectIEVersion();
						a && a <= 9 ? (o = new moxie.xhr.XMLHttpRequest, moxie.core.utils.Env.swf_url = e.flash_swf_url) : o = that.createAjax(), o.open("GET", r, !1);
						var s = function() {
							if(logger.debug("ajax.readyState: ", o.readyState), 4 === o.readyState)
								if(logger.debug("ajax.status: ", o.status), o.status < 400) {
						...
						a && a <= 9 ? o.bind("readystatechange", s) : o.onreadystatechange = s, o.send()
					},
					n = function(t) {
						return !that.token || e.uptoken_url && that.tokenInfo.isExpired() ? r(t) : that.token
					},
					r = function(t) {
						if(e.uptoken) that.token = e.uptoken;
							...
							if(n.open("GET", that.uptoken_url, !1), n.send(), 200 === n.status) {
								...
								var o = that.token.split(":"),
									a = that.parseJSON(that.URLSafeBase64Decode(o[2]));
								that.tokenMap || (that.tokenMap = {});
								var s = function(e) {
										return Math.ceil(e.getTime() / 1e3)
									},
									u = s(new Date(n.getResponseHeader("date"))),
									l = s(new Date);
								that.tokenInfo = {
									serverDelay: l - u,
									deadline: a.deadline,
									isExpired: function() {
										return this.deadline - s(new Date) + this.serverDelay < 600
									}
					...
					o = function(t, i, n) {
						var r = "",
							o = !1;
						if(!e.save_key)
							if(o = t.getOption && t.getOption("unique_names"), o = o || t.settings && t.settings.unique_names) {
								var a = that.getFileExtension(i.name);
								r = a ? i.id + "." + a : i.id
				...
				e.init.Error = function() {}, e.init.FileUploaded = function() {}, that.uptoken_url = e.uptoken_url, that.token = "", that.key_handler = "function" == typeof e.init.Key ? e.init.Key : "", this.domain = e.domain;
				var d = "",
					f = {
						isResumeUpload: !1,
						resumeFilesize: 0,
				...
				h && h <= 9 && (p.multipart_params.accept = "text/plain; charset=utf-8", logger.debug("add accept text/plain in multipart params")), plupload.extend(u, e, p), logger.debug("option: ", u);
				...
				logger.debug("new plupload.Uploader(option)"), m.bind("Init", function(t, i) {
					...
					var a = function(t, i, n) {
							...
							var a = that.detectIEVersion();
							a && a <= 9 && (r.accept = "text/plain; charset=utf-8", logger.debug("add accept text/plain in multipart params")), logger.debug("directUpload multipart_params_obj: ", r);
							var u = e.x_vars;
							if(void 0 !== u && "object" == typeof u)
								for(var l in u) u.hasOwnProperty(l) && ("function" == typeof u[l] ? r["x:" + l] = u[l](t, i) : "object" != typeof u[l] && (r["x:" + l] = u[l]));
							t.setOption({
								url: qiniuUploadUrl,
								multipart: !0,
								chunk_size: s() ? e.max_file_size : void 0,
								multipart_params: r
							})
						},
						s = function() {
					...
					if(u = u || t.settings && t.settings.chunk_size, logger.debug("uploader.runtime: ", m.runtime), logger.debug("chunk_size: ", u), "html5" !== m.runtime && "flash" !== m.runtime || !u) logger.debug("directUpload because uploader.runtime !== 'html5' || uploader.runtime !== 'flash' || !chunk_size"), a(t, i, that.key_handler);
					else if(i.size < u || s()) logger.debug("directUpload because file.size < chunk_size || is_android_weixin_or_qq()"), a(t, i, that.key_handler);
					else {
						...
						if(l) {
							...
							var p = (new Date).getTime(),
								h = l.time || 0;
							p - h < 864e5 && 100 !== l.percent && i.size === l.total ? (i.percent = l.percent, i.loaded = l.offset, d = l.ctx, f.isResumeUpload = !0, f.resumeFilesize = l.offset, l.offset + c > i.size && (c = i.size - l.offset)) : localStorage.removeItem(i.name)
						}
						f.startTime = (new Date).getTime();
						var g = {},
					...
					logger.trace("UploadProgress event activated"), f.currentTime = (new Date).getTime();
					var i = f.currentTime - f.startTime,
						n = t.loaded || 0;
					f.isResumeUpload && (n = t.loaded - f.resumeFilesize), t.speed = (n / i * 1e3).toFixed(0) || 0
					...
					a = a || e.settings && e.settings.chunk_size, o < a && (e.setOption({
						url: qiniuUploadUrl + "/mkblk/" + o
					}), logger.debug("up.setOption url: ", qiniuUploadUrl + "/mkblk/" + o)), e.setOption({
						headers: {
				...
				return m.bind("Error", function(t) {
					return function(i, n) {
						...
						if(i.refresh(), !e.disable_statistics_report) {
							var f = n && n.responseHeaders && n.responseHeaders.match ? n.responseHeaders.match(/(X-Reqid\:\ )([\w\.\%-]*)/) : [];
//							console.log(n);
							var p = f[2].replace(/[\r\n]/g, ""),
								h = plupload.HTTP_ERROR ? n.status : n.code,
								g = u._start_at ? u._start_at.getTime() : r.getTime();
							statisticsLogger.log(0 === h ? ExtraErrors.NetworkError : h, p, a(i.settings.url), void 0, s(i.settings.url), (r.getTime() - g) / 1e3, parseInt(g / 1e3), n.file.size * (n.file.percent / 100), "jssdk-" + i.runtime, u.size)
						}
					}
					...
					return function(i, n, r) {
									...
									o.open("POST", e.downtoken_url, !0), o.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), o.onreadystatechange = function() {
										if(4 === o.readyState)
											if(200 === o.status) {
												...
												var a = {};
												plupload.extend(a, that.parseJSON(r.response), e), r.response = that.stringifyJSON(a), t && t(i, n, r)
						...
						if(d = d || c.ctx, logger.debug("ctx: ", d), d) {
							var f = "";
							logger.debug("save_key: ", e.save_key), e.save_key || (f = o(i, n, that.key_handler), f = f ? "/key/" + that.URLSafeBase64Encode(f) : "");
							var p = "/fname/" + that.URLSafeBase64Encode(n.name);
							logger.debug("op.x_vars: ", e.x_vars);
							var h = e.x_vars,
								g = "",
								v = "";
							if(void 0 !== h && "object" == typeof h)
								for(var x in h) h.hasOwnProperty(x) && ("function" == typeof h[x] ? g = that.URLSafeBase64Encode(h[x](i, n)) : "object" != typeof h[x] && (g = that.URLSafeBase64Encode(h[x])), v += "/x:" + x + "/" + g);
							var _, y = qiniuUploadUrl + "/mkfile/" + n.size + f + p + v,
								w = that.detectIEVersion();
							w && w <= 9 ? (_ = new moxie.xhr.XMLHttpRequest, moxie.core.utils.Env.swf_url = e.flash_swf_url) : _ = that.createAjax(), _.open("POST", y, !0), _.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"), console.log("uptoken:" + that.token), _.setRequestHeader("Authorization", "UpToken " + that.token);
							var E = function() {
...
//							console.log(r.responseHeaders);
							...
							statisticsLogger.log(r.status, b, a(i.settings.url), void 0, s(i.settings.url), (u.getTime() - R) / 1e3, parseInt(R / 1e3), n.size, "jssdk-" + i.runtime, n.size)
						}
					}
				}(c)), logger.debug("bind FileUploaded event"), m.bind("FilesRemoved", function(t, i) {
					var n = new Date;
					if(!e.disable_statistics_report)
						for(var r = 0; r < i.length; r++) statisticsLogger.log(ExtraErrors.Cancelled, void 0, a(t.settings.url), void 0, s(t.settings.url), (n.getTime() - i[r]._start_at.getTime()) / 1e3, i[r]._start_at.getTime() / 1e3, i[r].size * i[r].percent / 100, "jssdk-" + t.runtime, i[r].size)
			...
			}, this.imageView2 = function(e, t) {
				if(!/^\d$/.test(e.mode)) return !1;
				var i = e.mode,
					n = e.w || "",
					r = e.h || "",
					o = e.q || "",
				...
				if(!n && !r) return !1;
				var s = "imageView2/" + i;
				return s += n ? "/w/" + n : "", s += r ? "/h/" + r : "", s += o ? "/q/" + o : "", s += a ? "/format/" + a : "", t && (s = this.getUrl(t) + "?" + s), s
			}, this.imageMogr2 = function(e, t) {
				var i = e["auto-orient"] || "",
					n = e.thumbnail || "",
					r = e.strip || "",
					o = e.gravity || "",
					...
					c = e.blur || "",
					d = "imageMogr2";
				return d += i ? "/auto-orient" : "", d += n ? "/thumbnail/" + n : "", d += r ? "/strip" : "", d += o ? "/gravity/" + o : "", d += s ? "/quality/" + s : "", d += a ? "/crop/" + a : "", d += u ? "/rotate/" + u : "", d += l ? "/format/" + l : "", d += c ? "/blur/" + c : "", t && (d = this.getUrl(t) + "?" + d), d
			}, this.watermark = function(e, t) {
				var i = e.mode;
				if(!i) return !1;
				var n = "watermark/" + i;
				if(1 === i) {
					var r = e.image || "";
					if(!r) return !1;
					n += r ? "/image/" + this.URLSafeBase64Encode(r) : ""
				} else {
					if(2 !== i) return !1;
					var o = e.text ? e.text : "",
						a = e.font ? e.font : "",
						s = e.fontsize ? e.fontsize : "",
						u = e.fill ? e.fill : "";
					if(!o) return !1;
					n += o ? "/text/" + this.URLSafeBase64Encode(o) : "", n += a ? "/font/" + this.URLSafeBase64Encode(a) : "", n += s ? "/fontsize/" + s : "", n += u ? "/fill/" + this.URLSafeBase64Encode(u) : ""
				}
				var l = e.dissolve || "",
					c = e.gravity || "",
					d = e.dx || "",
					f = e.dy || "";
				return n += l ? "/dissolve/" + l : "", n += c ? "/gravity/" + c : "", n += d ? "/dx/" + d : "", n += f ? "/dy/" + f : "", t && (n = this.getUrl(t) + "?" + n), n
			}, this.imageInfo = function(e) {
				if(!e) return !1;
				var t, i = this.getUrl(e) + "?imageInfo",
					n = this.createAjax(),
					r = this;
				return n.open("GET", i, !1), n.onreadystatechange = function() {
					4 === n.readyState && 200 === n.status && (t = r.parseJSON(n.responseText))
				}, n.send(), t
			}, this.exif = function(e) {
				if(!e) return !1;
				var t, i = this.getUrl(e) + "?exif",
					n = this.createAjax(),
					r = this;
				return n.open("GET", i, !1), n.onreadystatechange = function() {
					4 === n.readyState && 200 === n.status && (t = r.parseJSON(n.responseText))
				...
				return !(!t || !e) && ("exif" === e ? this.exif(t) : "imageInfo" === e && this.imageInfo(t))
			}, this.pipeline = function(e, t) {
				var i, n, r = "[object Array]" === Object.prototype.toString.call(e),
					o = "";
				if(r) {
					for(var a = 0, s = e.length; a < s; a++) {
						if(i = e[a], !i.fop) return !1;
						switch(i.fop) {
							case "watermark":
								o += this.watermark(i) + "|";
								break;
