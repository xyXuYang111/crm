    ...
    var App = App ||
        {
            init: function () {
                ...
                $("#search-input").off().on("keydown",function (e) {
					e.stopPropagation();

                    setTimeout(function () {
                        var searchinput=$("#search-input").val();
                        var title = encodeURI(encodeURI(searchinput));
                    	if(searchinput!=""){
                            window.location.href="search.html?s="+title;
						}

                    },3000);

                    ///window.location="search.html?s="+title;
                    //console.log("111");
                })
