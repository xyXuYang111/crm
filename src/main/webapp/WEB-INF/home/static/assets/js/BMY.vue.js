var template = {
    footer:
        '<div id="jsi-flying-fish-container" class="containeryu">'+
        '<div class="bottom-naav">' +
        '   <div class="layui-row">' +
        '       <div class="layui-col-md4 layui-col-md-offset4 copyright">' +
        '           <p v-html="words" style="text-align: center;">' +
        '               <i class="fa fa-copyright"></i>&nbsp;{{words}}' +
        '           </p>' +
        '       </div>' +
        '   </div> ' +
        '</div>'+
    ...
    header:
        ...
        '                <a @click="searchDialog" :class="{ active: search }" target="_blank"><i class="layui-icon">&#xe615;</i> {{params.menu_search}}</a>' +
    ...
    ,
    headerNew:
        '<div class="fly-header " style="background: linear-gradient(#2fb3e8,#7dd2f1);">\n' +
        '        <div class="layui-container">\n' +
        '            <a class="fly-logo" href="/">\n' +
        '                <img src="/static/assets/img/logo.png" style="width: 140px;" alt="nonelonely">\n' +
        '            </a>\n' +
        '            <ul class="layui-nav fly-nav layui-hide-xs">\n' +
        '                <li class="layui-nav-item ">\n' +
        '                    <a href="/"><i class="iconfont icon-daima"></i>{{params.menu_home}}</a>\n' +
        '                </li>\n' +
        '                <li class="layui-nav-item">\n' +
        '                    <a href="/note"><i class="iconfont icon-iconmingxinganli"></i>{{params.menu_note}}</a>\n' +
        '                </li>\n' +
        '                <li class="layui-nav-item">\n' +
        '                    <a href="/msg"><i class="iconfont icon-jiaoliu"></i>{{params.menu_mine}}</a>\n' +
        '                </li>\n' +
        '                <li class="layui-nav-item">\n' +
        '                    <a href="/about"><i class="iconfont icon-biaoqing"></i>关于</a>\n' +
        '                </li>\n' +
        '            </ul>\n' +
        '\n' +
        ...
        // '                </li>\n' +
        '                <li v-if="params.qq_login == 1" class="layui-nav-item">\n' +
        '                    <a href="#"  @click="goto()" title="QQ登入" class="iconfont icon-qq"><span style="font-size: 5px;">QQ登陆</span></a>\n' +
        '                </li>\n' +
        '\n' +
        '</template>'+
        '                <!-- 登入后的状态 -->\n' +
        ...
        '                    <cite class="layui-hide-xs">{{su.nickname}}</cite>\n' +
        '                    <img :src="su != null ?su.avatar:\'\'">\n' +
        '                  </a>\n' +
        '                  <dl class="layui-nav-child">\n' +
        // '                    <dd><a href="user/set.html"><i class="layui-icon">&#xe620;</i>基本设置</a></dd>\n' +
        // '                    <dd><a href="user/message.html"><i class="iconfont icon-tongzhi" style="top: 4px;"></i>我的消息</a></dd>\n' +
        // '                    <dd><a href="user/home.html"><i class="layui-icon" style="margin-left: 2px; font-size: 22px;">&#xe68e;</i>我的主页</a></dd>\n' +
        '                    <dd v-if="su !=null && su.dri == 1"><a href="/management/index" target="_blank">管理后台</a></dd> \n'+
        '                    <dd><a href="/management/logout" style="text-align: center;">退出</a></dd>\n' +
        '                  </dl>\n' +
        '                </li>\n' +
        '            \n' +
        '    </template>'+
        ...
        '</div>'
    ,footNew:
        '<div class="fly-foot layui-bg-green">' +
        '        <div class="layui-container">' +
    ...
    ,block:
        ...
        '            <li><a :href="cateUrl(c)">{{c.cnName}}</a></li>\n' +
        '       </template>' +
        '        </ul>\n' +
        '        <div class="fly-column-right layui-hide-xs">\n' +
        '            <div class="clock-font">当前日期</span>：<span id="current-datetime"></span></div>\n' +
        '        </div>\n' +
        '    </div>\n' +
        '</div>'
    ,
    blocks:
        ...
        '        <blockquote class="layui-elem-quote" style="border-left: 5px solid rgba(244, 67, 54, 1);background-color: white;">' +
        '            <template v-if="quote.showBlog">博文统计：共【<span class="sum-font">{{quote.blogCount}}</span>】篇；</template>' +
        '            <template v-if="quote.showNote">资源统计：共【<span class="sum-font">{{quote.noteCount}}</span>】条；</template>' +
    ...
    ,
    infoNew:
        '<div class="layui-tab layui-tab-card layui-article-cate layui-hide-xs">' +
    ...
    lot:
        ...
        '       <hr>' +
        '       <template v-for="(r, n) in lots">' +
        '         <a :href="\'/article/\'+r.id" style="margin-bottom: 10px">' +
        '          <span v-if="n==0"   class="layui-badge">{{n+1}}</span>' +
        '         <span v-if="n==1"   class="layui-badge layui-bg-orange">{{n+1}}</span> ' +
        '         <span v-if="n==2"   class="layui-badge layui-bg-green">{{n+1}}</span>' +
        '         <span v-if="n>2"   class="layui-badge layui-bg-gray">{{n+1}}</span>' +
        '        &nbsp; &nbsp;{{subTitle(r.title)}}</a>' +
        '         <span class="views" style="float: right"><i class="fa fa-thermometer-half"></i> {{ r.view }}<code style="font-family: cursive;">℃</code></span></br>' +
        '       </template>' +
        '   </div> ' +
        '</div>'
    ,
    random:
        ...
        '       <p class="title">博文栈</p>' +
        '       <hr>' +
        '       <template v-for="(r, n) in articles">' +
        '         <a :href="\'/article/\'+r.id" style="margin-bottom: 10px">' +
        '          <span v-if="n==0"   class="layui-badge">{{n+1}}</span>' +
        '         <span v-if="n==1"   class="layui-badge layui-bg-orange">{{n+1}}</span> ' +
        '         <span v-if="n==2"   class="layui-badge layui-bg-green">{{n+1}}</span>' +
        '         <span v-if="n>2"   class="layui-badge layui-bg-gray">{{n+1}}</span>' +
        '        &nbsp; &nbsp;{{subTitle(r.title)}}</a></br>' +
        '       </template>' +
        '   </div> ' +
        '</div>'
    ,
    ...
    similar:
        ...
        '          <a :href="\'/article/\'+a.id"> <span class="layui-badge-dot"></span> &nbsp; &nbsp;{{subTitle(a.title)}}</a><br>' +
        '       </template>' +
        '   </div> ' +
        '</div>'
    ,
    comment:
        ...
        '               <a v-if="su == null" class="layui-btn layui-btn-sm" style="float: right;width: 120px;background-color: #f44336;"  href="#"  @click="beforeLogin();" id="beforeLogin"><i class="fa fa-qq"></i> 请先登录</a>' +
        '           </fieldset>' +
        '       </div>' +
        '   </div>' +
        '</div>'
    ...
    messageComment:
        ...
        '               <legend>随便说两句</legend>' +
        '               <div class="layui-field-box">' +
        '                   <label for="comment-inputs"></label>' +
        '                       <textarea id="comment-inputs" style="display: none;"></textarea>' +
        '               </div>' +
    ...
    commentArea:
        ...
        '                   <p v-if="comments.totalElements == 0" class="text-center">暂无评论</p>' +
        '                   <blockquote id="cccc" class="layui-elem-quote layui-mt20" style="border-left: 5px solid #F44336;" v-html="tips"></blockquote>' +

        '                   <template v-for="c in comments.content" v-if="c.enable">' +
    ...
    '                           <div class="layui-row">' +
        ...
        '                                   <i class="fa fa-user-o"></i> <span class="comment-user" :style="masterColor(c.userId)">{{c.user.nickname}}&nbsp;<svg v-if="c.userId==1" class="icon" aria-hidden="true"><use xlink:href="#icon-renzhengkaobei"></use></svg>&nbsp;&nbsp;</span><small><i class="fa fa-location-arrow"></i> {{c.ipCnAddr}}网友</small><br/>' +
        ...
        '                                    <a @click="reback(c.userId,c.user.nickname,c.comment);" style="cursor: pointer;"> <i class="fa fa-comment"></i> 回复</a>' +
        '                               </div>' +
        '                           </div>' +
        '                       </div>' +
        '                       <hr style="background-color: #c1bfbf">' +
        '                   </template>' +
...
Vue.component('bmy-header', {
    ...
    , methods: {
        ...
        ,goto:function () {
            ...
            //
            //         clearInterval(loop);
            //         layer.msg('登陆成功，自动刷新界面', {icon:16, shade: 0.1, time:0} )
...
Vue.component('bmy-comment', {
    ...
    , methods: {
        submit: function (articleId) {
            ...
            var useredId=BMY.userId===undefined?0:BMY.userId;
            var avatar=this.su.avatar;
            var name=this.su.nickname;
                ...
                $.post("/token/comment/sub", {
                    ...
                    setTimeout(function () {
                        ...
                        //    location.href = "/article/" + articleId + "?_" + new Date().getTime() + "#cta"
                            $(window.frames["LAY_layedit_3"].document).find("body").html('');
                       var str=     '                       <div class="layui-row comment-block" >' +
                            '                           <div class="layui-row">' +
                            '                               <div class="layui-col-md1 layui-col-xs1 comment-avatar">' +
                            '                                   <img class="layui-circle" src="'+avatar+'">' +
                            '                               </div>' +
                            '                               <div class="layui-col-md10 layui-col-xs9" style="border-bottom: 1px dotted #dbdbdb;padding-bottom: 10px;">' +
                            '                                   <i class="fa fa-user-o"></i> <span class="comment-user" >'+name+'&nbsp;<svg class="icon" aria-hidden="true"><use xlink:href="#icon-renzhengkaobei"></use></svg>&nbsp;&nbsp;</span><small><i class="fa fa-location-arrow"></i> 自己</small><br/>' +
                            '                                   <i class="fa fa-clock-o"></i> <span class="comment-datetime">'+new Date() +'</span>' +
                            '                               </div>' +
                            '                               <div class="layui-row comment-block-content">' +
                            '                                   <p >'+comment+'</p>' +
                            '                               </div>' +
...
Vue.component('bmy-comment-list', {
    ...
    , methods: {
        ...
        , reback: function (userid,name, content) {
            BMY.userId=userid;
            BMY.tempHtml =
                '<blockquote class="layui-elem-quote layui-quote-nm" style="border-color: #bfbaba;">' +
                '   <a href="#" class="re">回复@' + name + '</a>：' + content +
                '</blockquote>';
            BMY.tempHtml2 =
                '<a href="#" class="re">回复@' + name + '</a>：';

           $(window.frames[2].document).find("body").html(BMY.tempHtml2);
...
Vue.component('bmy-comment-lists', {
    template: template.commentArea
    , props: {
        comments: {
            type: Object
    ...
    , methods: {
        ...
        , reback: function (userid,name, content) {
            ...
            $(window.frames[0].document).find("body").html(BMY.tempHtml2);
            //  document.getElementsByTagName('body')[1].
            location.href = "#cta";
        }
    }
