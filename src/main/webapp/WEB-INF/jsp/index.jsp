...
<body>
    ...
    <div class="home-menu">
        <ul>
            <li><a href="${contextPath}/indexPage.do">首页</a></li>
            <li><a href="${contextPath}/indexPage.do">主页</a></li>
            <li><a href="${contextPath}/fileIndex.do">文件</a></li>
            <li><a href="${contextPath}/messageIndex.do">点滴</a></li>
            <li><a href="${contextPath}/loggerIndex.do">日志</a></li>
            <li><a href="${contextPath}/about.do">关于</a></li>
        </ul>
    </div>
