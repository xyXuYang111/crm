		...
		<header>
			<ul class="layui-nav">
				...
				<li class="layui-nav-item" >
					<a href="/loggerIndex.do">日志清单</a>
				</li>
				<li class="layui-nav-item">
					<a href="/loggerSqlList.do">sql日志</a>
				</li>
				<li class="layui-nav-item">
					<a href="/loggerMongoDBList.do">mongoDB日志</a>
				</li>
				<li class="layui-nav-item">
					<a href="/loggerErrorList.do">redis错误日志</a>
				</li>
				<li class="layui-nav-item">
					<a href="/loggerRequestList.do">redis请求日志</a>
				</li>
			</ul>
		</header>
